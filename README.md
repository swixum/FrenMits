...
- Sheet import. Paste rows from Google Sheets or Excel and map the columns.
- Ability icons on every call.
- Share fights by exporting and importing through the clipboard.
...
Any other fight can be added and imported by hand.
