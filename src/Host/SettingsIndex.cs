...
internal static class SettingsIndex
{
    ...
    public static readonly Entry[] All =
    {
        ...
        E(ConfigWindow.NavKind.Meter, "Display", "Collapsed", nameof(Configuration.MeterCollapsed), "rolled up"),
        ...
        E(ConfigWindow.NavKind.Meter, "Display", "Column labels", nameof(Configuration.MeterColumnHeader), "header"),
        E(ConfigWindow.NavKind.Meter, "Display", "Call your row \"You\"", nameof(Configuration.MeterYou), "name"),
        ...
        E(ConfigWindow.NavKind.Meter, "Display", "Always on screen", nameof(Configuration.MeterAlwaysShow), "visible"),
        E(ConfigWindow.NavKind.Meter, "Display", "Hide out of combat", nameof(Configuration.MeterHideOutOfCombat), "auto hide"),
