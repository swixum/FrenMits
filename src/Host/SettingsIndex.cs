...
internal static class SettingsIndex
{
    ...
    public static readonly Entry[] All =
    {
        ...
        E(ConfigWindow.NavKind.Display, "Look", "Call style", nameof(Configuration.OverlayStyle), "classic board icon clock"),
        E(ConfigWindow.NavKind.Display, "Look", "Ability icon", nameof(Configuration.ShowAbilityIcon), "action image"),
        E(ConfigWindow.NavKind.Display, "Look", "Radial ring", nameof(Configuration.ShowRadialRing), "countdown circle"),
        E(ConfigWindow.NavKind.Display, "Look", "Call panel", nameof(Configuration.OverlayCallPanel), "plate plate background"),
        E(ConfigWindow.NavKind.Display, "Look", "Text spark", nameof(Configuration.OverlayTextSpark), "wipe bar edge"),
        E(ConfigWindow.NavKind.Display, "Look", "Mechanic 2nd line", nameof(Configuration.ShowMechanicLine), "second line"),
        E(ConfigWindow.NavKind.Display, "Look", "Countdown number", nameof(Configuration.ShowCountdownNumber), "seconds"),
        E(ConfigWindow.NavKind.Display, "Look", "Drop shadow", nameof(Configuration.TextShadow), "outline readability"),
        E(ConfigWindow.NavKind.Display, "Look", "Cooldown warnings", nameof(Configuration.CooldownAwareCalls), "cd red"),
        E(ConfigWindow.NavKind.Display, "Look", "Call format", nameof(Configuration.HeadlineFormat), "placeholder template"),
        E(ConfigWindow.NavKind.Display, "Look", "\"NOW\" suffix", nameof(Configuration.ActiveSuffix), "now text"),
        E(ConfigWindow.NavKind.Display, "Look", "Font", nameof(Configuration.OverlayFontFamily), "typeface family"),
        E(ConfigWindow.NavKind.Display, "Look", "Call size", nameof(Configuration.OverlayFontSizePx), "text size bigger smaller"),
        E(ConfigWindow.NavKind.Display, "Look", "Align", nameof(Configuration.OverlayTextAlign), "left center right"),
        E(ConfigWindow.NavKind.Display, "Look", "Icon size", nameof(Configuration.IconScale), "scale"),
        E(ConfigWindow.NavKind.Display, "Look", "Counting down", nameof(Configuration.OverlayColorImminent), "color"),
        E(ConfigWindow.NavKind.Display, "Look", "NOW", nameof(Configuration.OverlayColorActive), "color active"),
        E(ConfigWindow.NavKind.Display, "Look", "Mechanic", nameof(Configuration.OverlayColorMechanic), "color"),
        E(ConfigWindow.NavKind.Display, "Look", "Color the call by mit type", nameof(Configuration.ColorByMitType), "party tank personal"),
        E(ConfigWindow.NavKind.Display, "Look", "Countdown bar under the call", nameof(Configuration.ShowProgressBar), "progress"),
        E(ConfigWindow.NavKind.Display, "Look", "Height", nameof(Configuration.ProgressBarHeight), "bar thickness"),
        E(ConfigWindow.NavKind.Display, "Look", "Pulse the text in the last second", nameof(Configuration.PulseWhenImminent), "flash"),
        E(ConfigWindow.NavKind.Display, "Look", "Draw a background box", nameof(Configuration.ShowBackground), "backdrop"),
        ...
        E(ConfigWindow.NavKind.Display, "Theme", "Accent color", nameof(Configuration.AccentColor), "theme tint highlight"),
        E(ConfigWindow.NavKind.Display, "Theme", "UI scale", nameof(Configuration.UiScale), "text size window bigger zoom"),
        ...
        E(ConfigWindow.NavKind.NextMits, "Look", "Countdown seconds", nameof(Configuration.UpcomingBoardTimeText), "time text"),
        E(ConfigWindow.NavKind.NextMits, "Look", "Planned mits", nameof(Configuration.UpcomingBoardShowActions), "actions"),
        E(ConfigWindow.NavKind.NextMits, "Look", "Severity marks (! !! !!!)", nameof(Configuration.UpcomingBoardShowSeverity), "danger"),
        E(ConfigWindow.NavKind.NextMits, "Look", "Tank buster icon", nameof(Configuration.UpcomingBoardShowType), "shield"),
        E(ConfigWindow.NavKind.NextMits, "Look", "Mechanic type chip", nameof(Configuration.UpcomingBoardTypeChip), "tag buster raid aoe enrage"),
        E(ConfigWindow.NavKind.NextMits, "Look", "Short chip labels", nameof(Configuration.UpcomingBoardTypeChipShort), "tb aoe enr"),
        E(ConfigWindow.NavKind.NextMits, "Look", "Boss reposition calls", nameof(Configuration.UpcomingBossPosition), "return spot"),
        E(ConfigWindow.NavKind.NextMits, "Look", "Phase dividers", nameof(Configuration.UpcomingBoardPhases), "separator"),
        ...
        E(ConfigWindow.NavKind.CombatTimer, "Look", "Font", nameof(Configuration.CombatTimerFontFamily), "typeface"),
        E(ConfigWindow.NavKind.CombatTimer, "Look", "Text size", nameof(Configuration.CombatTimerFontSizePx), "size"),
        E(ConfigWindow.NavKind.CombatTimer, "Look", "Text color", nameof(Configuration.CombatTimerColor), "color"),
        E(ConfigWindow.NavKind.CombatTimer, "Look", "Draw a background box", nameof(Configuration.CombatTimerShowBackground), "backdrop"),
        ...
        E(ConfigWindow.NavKind.Meter, "Meter", "Lock position and size", nameof(Configuration.MeterLocked), "drag"),
        E(ConfigWindow.NavKind.Meter, "Meter", "Click-through", nameof(Configuration.MeterClickThrough), "mouse"),
        E(ConfigWindow.NavKind.Meter, "Meter", "Rank numbers", nameof(Configuration.MeterShowRank), "position"),
        E(ConfigWindow.NavKind.Meter, "Meter", "Job icons", nameof(Configuration.MeterShowJobIcons), "class"),
        E(ConfigWindow.NavKind.Meter, "Columns", "Column labels", nameof(Configuration.MeterColumnHeader), "header"),
        E(ConfigWindow.NavKind.Meter, "Look", "Call your row \"You\"", nameof(Configuration.MeterYou), "name"),
        E(ConfigWindow.NavKind.Meter, "Meter", "Limit break row", nameof(Configuration.MeterLimitBreakRow), "lb"),
        E(ConfigWindow.NavKind.Meter, "Meter", "Split DPS/HPS", nameof(Configuration.MeterSplitHealing), "healing"),
        E(ConfigWindow.NavKind.Meter, "Meter", "Rows shown", nameof(Configuration.MeterMaxRows), "how many"),
        E(ConfigWindow.NavKind.Meter, "Meter", "Raid rDPS total", nameof(Configuration.MeterShowRaidTotal), "sum"),
        E(ConfigWindow.NavKind.Meter, "Meter", "DPS / HPS tabs", nameof(Configuration.MeterHealingTab), "tabs"),
        E(ConfigWindow.NavKind.Meter, "Meter", "Buttons bar", nameof(Configuration.MeterButtons), "history pause reset"),
        E(ConfigWindow.NavKind.Meter, "Meter", "Death count", nameof(Configuration.MeterFooterDeaths), "deaths footer"),
        E(ConfigWindow.NavKind.Meter, "Meter", "Show", nameof(Configuration.MeterShowMode), "always after a pull only in combat visible auto hide"),
        E(ConfigWindow.NavKind.Meter, "Meter", "Action icons", nameof(Configuration.MeterBreakdownIcons), "breakdown"),
        E(ConfigWindow.NavKind.Meter, "Meter", "Color each ability", nameof(Configuration.MeterBreakdownColors), "breakdown"),
        E(ConfigWindow.NavKind.Meter, "Look", "Color by job", nameof(Configuration.MeterJobColors), "bar color"),
        E(ConfigWindow.NavKind.Meter, "Look", "Solid bars", nameof(Configuration.MeterBarSolid), "opaque"),
        E(ConfigWindow.NavKind.Meter, "Look", "Highlight your row", nameof(Configuration.MeterHighlightYou), "you"),
        E(ConfigWindow.NavKind.Meter, "Look", "Drop shadow", nameof(Configuration.MeterTextShadow), "outline"),
    };
