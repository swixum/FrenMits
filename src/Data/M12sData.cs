...
public static class M12sData
{
    ...
    public static readonly Entry[] Timeline =
    {
        ...
        new(108, "P1", "The Fixer", 0, new[]{"","Party Mit (WAR/PLD)","Plenary Indulgence","Collective Unconscious","","","","","",""}),
        ...
        new(241, "P1", "The Fixer", 0, new[]{"","Party Mit (WAR/PLD)","Plenary Indulgence","Collective Unconscious","","","","","",""}),
        ...
        new(342, "P1", "Slaughtershed I", 0, new[]{"","Reprisal","Plenary Indulgence","Collective Unconscious","Sacred Soil + Fey Illumination + Seraphism","Kerachole + Philosophia","Feint","","","Addle"}),
        ...
        new(437, "P2", "Arcadia Aflame", 0, new[]{"Reprisal","Party Mit","Plenary Indulgence","Collective Unconscious","Spreadlo + Sacred Soil","Holos + Kerachole","Feint","","Party Mit","Addle"}),
        ...
        new(581, "P2", "Reenactment", 0, new[]{"Party Mit","Reprisal","Plenary Indulgence + Temperance + Divine Caress","Collective Unconscious + Neutral Sect + Sun Sign","Expedient + Seraph + Sacred Soil","Zoe Shields + Panhaima + Kerachole","","Feint","",""}),
        new(622, "P2", "Blood Mana", 0, new[]{"","","","","Sacred Soil","Kerachole","","","",""}),
        new(650, "P2", "Netherworld Near/Far", 0, new[]{"Reprisal","Party Mit (DRK/GNB)","Plenary Indulgence","Collective Unconscious","Sacred Soil","Kerachole","Feint","","Party Mit","Addle"}),
        ...
        new(765, "P2", "Lindwurm's Meteor", 0, new[]{"Reprisal","Party Mit","Plenary Indulgence","Collective Unconscious","Sacred Soil","Kerachole","Feint","","Party Mit","Addle"}),
        ...
        new(893, "P2", "Idyllic Dream", 0, new[]{"Party Mit","Reprisal","Plenary Indulgence","Collective Unconscious","Sacred Soil","Kerachole","Feint","","","Addle"}),
