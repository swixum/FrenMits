...
public static class DmuData
{
    ...
    public static readonly Entry[] Timeline =
    {
        ...
        new(88, "P1", "Gravitas II (Part I)", 0xBAAC, new[]{"","","Liturgy of the Bell (Optional)","Macrocosmos","Seraphism","","","","","",""}),
        ...
        new(118, "P1", "Double-Trouble Trap", 0xBAA7, new[]{"","Reprisal + Party Mit (GNB/DRK)","","","","Panhaima + Zoe Shields","","","Party Mit","",""}),
        new(133, "P1", "Light of Judgment", 0xC622, new[]{"Reprisal","Party Mit (WAR/PLD)","Plenary Indulgence","Collective Unconscious","Sacred Soil","Kerachole","Feint","","","",""}),
        ...
        new(451, "P3", "Bowels of Agony (Chaos)", 0xBAF2, new[]{"Reprisal","","Plenary Indulgence","Collective Unconscious","Sacred Soil","Kerachole","Feint (Chaos)","","","Addle (The Decisive Battle)",""}),
        new(470, "P3", "Stray Flames/Tsumani + Cyclone", 0xBAF8, new[]{"Party Mit","Reprisal","","","Seraph + Spreadlo + Sacred Soil","Zoe Shields + Kerachole","","","","","✔"}),
        new(496, "P3", "Stray Flames/Tsumani + Cyclone", 0, new[]{"","Party Mit","","","Expediant + Seraph","Holos","","","","",""}),
        new(508, "P3", "Ultima Blaster + Umbra Smash", 0xBB00, new[]{"Reprisal + LB3 (Vacuum Wave)","","Temperance","Neutral Sect + Sun Sign","Sacred Soil + Fey Illumination + Seraphism","Kerachole + Panhaima","","Feint (Chaos)","Party Mit","",""}),
        ...
        new(535, "P3", "Thunder III (Exdeath)", 0xBAE2, new[]{"","","","","","","","","","",""}),
        new(544, "P3", "The Decisive Battle", 0, new[]{"","","","","Spreadlo","Zoe Shields","","","","Addle (End of Castbar)",""}),
        new(559, "P3", "Earthquake (HP to 1)", 0, new[]{"Party Mit (GNB/DRK)","Reprisal","","Macrocosmos","Sacred Soil","Philosophia + Kerachole","Feint (Chaos)","","","",""}),
        new(579, "P3", "Shocking Impact", 0xBAF4, new[]{"Reprisal + Party Mit (WAR/PLD)","","Plenary Indulgence","Collective Unconscious","","","","","","",""}),
        new(595, "P3", "Thunder III (Exdeath)", 0, new[]{"","","","","","","","","","",""}),
        new(609, "P3", "Shocking Impact", 0xBAFD, new[]{"","Party Mit","Liturgy of the Bell","","Expedient + Seraph + Sacred Soil","Holos + Kerachole","","","","","✔"}),
        new(623, "P3", "Earthquakes", 0xC571, new[]{"","","","","","","","","","",""}),
        new(657, "P3", "Earthquakes", 0, new[]{"","","","","","","","","","",""}),
        new(677, "P3", "Shockwave", 0, new[]{"","","","","Sacred Soil","Kerachole","","","Party Mit","",""}),
        new(709, "P3", "Stomp-a-Mole", 0xBAF0, new[]{"Reprisal + Party Mit","","Plenary Indulgence","Collective Unconscious","Seraphism + Sacred Soil","Kerachole","Feint (Chaos)","","","",""}),
        new(745, "P4", "Kefka Returns (phase enter)", 0xC2DC, new[]{"","","","","","","","","","",""}),
        new(759, "P4", "Grand Cross + Inferno/Tsunami", 0xBB14, new[]{"","","Temperance","Neutral Sect","Spreadlo + Expedient + Sacred Soil","Kerachole + Holos + Philosophia","","","","",""}),
        new(765, "P4", "Inferno/Tsunami", 0, new[]{"Reprisal","","","","","","","","","",""}),
        new(774, "P4", "Grand Cross + Inferno/Tsunami", 0xBB14, new[]{"","","Plenary Indulgence","Collective Unconscious","Fey Illumination","Panhaima","","Feint","Party Mit","","✔"}),
        new(779, "P4", "Inferno/Tsunami", 0, new[]{"","Party Mit (GNB/DRK)","","Sun Sign","Seraph","","","","","",""}),
        new(789, "P4", "Grand Cross", 0xBB14, new[]{"","Party Mit (WAR/PLD)","Divine Caress","","Seraph","Zoe Shields","","","","",""}),
        new(803, "P4", "Flood of Naught", 0xC393, new[]{"","Reprisal","Liturgy of the Bell","Macrocosmos","Sacred Soil","Kerachole","","","","",""}),
