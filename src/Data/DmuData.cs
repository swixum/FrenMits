...
public static class DmuData
{
    ...
    public static readonly Entry[] Timeline =
    {
        ...
        new(133, "P1", "Light of Judgment", 0xC622, new[]{"Reprisal + Party Mit", "", "Plenary Indulgence", "Collective Unconscious", "", "Kerachole", "Feint", "", "", "", ""}),
        ...
        new(249, "P2", "Towers I", 0xBABE, new[]{"Party Mit", "", "", "", "Seraph + Fey Illumination", "Panhaima", "", "", "", "", ""}),
        ...
        new(342, "P2", "Light of Judgement", 0xBABD, new[]{"Party Mit", "Reprisal", "", "", "Spreadlo + Sacred Soil", "Kerachole + Holos + Zoe Shields", "Feint", "", "Party Mit", "Addle", ""}),
        ...
        new(559, "P3", "Earthquake (HP to 1)", 0, new[]{"Party Mit (GNB/DRK)", "Reprisal", "", "Macrocosmos", "Sacred Soil", "Kerachole + Philosophia", "Feint (Chaos)", "", "", "", ""}),
        ...
        new(833, "P4", "Death Bolt/Wave", 0xBB1B, new[]{"", "", "Plenary Indulgence", "Collective Unconscious", "", "", "", "", "", "", ""}),
