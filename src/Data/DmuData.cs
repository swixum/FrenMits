...
public static class DmuData
{
    ...
    public static readonly Entry[] Timeline =
    {
        ...
        new(250, "P2", "Towers I", 0xBABE, new[]{"", "", "Asylum", "", "Seraph + Fey Illumination", "Panhaima", "", "", "", ""}, 2),
        new(251, "P2", "Spellscatter", 0, new[]{"","","","","","","","","",""}, 1, true),
        new(251, "P2", "Spellwave", 0, new[]{"","","","","","","","","",""}, 1, true),
        new(260, "P2", "Towers II (Past/Future's End)", 0xBABE, new[]{"", "", "", "", "Seraph", "", "", "", "", ""}, 1, true),
        new(261, "P2", "Spellscatter", 0, new[]{"","","","","","","","","",""}, 1, true),
        new(261, "P2", "Spellwave", 0, new[]{"","","","","","","","","",""}, 1, true),
        new(271, "P2", "Towers III (All Things Ending)", 0xBABE, new[]{"Party Mit", "Reprisal", "", "Macrocosmos", "Sacred Soil", "Kerachole", "", "", "", ""}, 2),
        new(272, "P2", "Spellscatter", 0, new[]{"","","","","","","","","",""}, 1, true),
        new(272, "P2", "Spellwave", 0, new[]{"","","","","","","","","",""}, 1, true),
        new(281, "P2", "Towers IV (Past/Future's End)", 0xBABE, new[]{"", "", "", "", "", "", "", "", "", ""}, 1, true),
        new(282, "P2", "Spellscatter", 0, new[]{"","","","","","","","","",""}, 1, true),
        new(282, "P2", "Spellwave", 0, new[]{"","","","","","","","","",""}, 1, true),
        new(292, "P2", "Towers V (All Things Ending)", 0xBABE, new[]{"", "", "Liturgy of the Bell", "", "Expedient", "", "", "", "", ""}, 2),
        new(293, "P2", "Spellscatter", 0, new[]{"","","","","","","","","",""}, 1, true),
        new(293, "P2", "Spellwave", 0, new[]{"","","","","","","","","",""}, 1, true),
        new(302, "P2", "Towers VI (Past/Future's End)", 0xBABE, new[]{"Reprisal", "", "Plenary Indulgence + Temperance", "Collective Unconscious + Neutral Sect", "Seraphism", "Philosophia", "", "", "", ""}, 1, true),
        new(303, "P2", "Spellwave", 0, new[]{"","","","","","","","","",""}, 1, true),
        new(312, "P2", "Towers VII (All Things Ending)", 0xBABE, new[]{"", "", "Divine Caress", "Sun Sign", "Sacred Soil", "Kerachole", "", "", "", ""}, 2),
        new(313, "P2", "Spellscatter", 0, new[]{"","","","","","","","","",""}, 1, true),
        new(313, "P2", "Spellwave", 0, new[]{"","","","","","","","","",""}, 1, true),
        new(323, "P2", "Towers VIII (Past/Future's End)", 0xBABE, new[]{"", "", "", "", "", "", "", "", "", ""}, 1, true),
        new(324, "P2", "Spellwave", 0, new[]{"","","","","","","","","",""}, 1, true),
        ...
        new(470, "P3", "Stray Flames/Tsunami", 0xBAF8, new[]{"Party Mit", "Reprisal", "", "", "Spreadlo + Sacred Soil", "Zoe Shields + Kerachole", "", "", "", ""}, 1, true),
        ...
        new(537, "P3", "Thunder III (2nd Set)", 0xBAE2, new[]{"", "", "", "", "", "", "", "", "", ""}, 2, true),
        ...
        new(578, "P3", "Shocking Impact/Shockwave", 0xBAF4, new[]{"Reprisal + Party Mit (WAR/PLD)", "", "Plenary Indulgence", "Collective Unconscious", "", "", "", "", "", ""}, 2),
        ...
        new(609, "P3", "Shocking Impact/Shockwave", 0xBAFD, new[]{"", "Party Mit (GNB/DRK)", "Liturgy of the Bell", "", "Expedient + Seraph + Sacred Soil", "Holos + Kerachole", "", "", "", ""}, 2),
        ...
        new(621, "P3", "Black Holes II (4th Tether Set)", 0xC571, new[]{"", "", "", "", "", "", "", "", "", ""}, 3, true),
