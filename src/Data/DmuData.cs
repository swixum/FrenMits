...
// new casts, and are NOT baked. Resync ability ids are cross-referenced from the cactbot
...
public static class DmuData
{
    ...
    public static readonly Entry[] Timeline =
    {
        ...
        new(43, "P1", "Wave Cannon", 0xBAA8, new[]{"Party Mit (WAR/PLD)", "", "Divine Caress", "", "Seraph", "Holos", "", "", "", ""}),
        ...
        new(132, "P1", "Light of Judgment", 0xC622, new[]{"Reprisal + Party Mit", "", "Plenary Indulgence", "Collective Unconscious", "", "Kerachole", "Feint", "", "", ""}),
        ...
        new(250, "P2", "Towers I", 0xBABE, new[]{"", "", "", "", "Seraph + Fey Illumination", "Panhaima", "", "", "", ""}),
        ...
        new(343, "P2", "Light of Judgement", 0xBABD, new[]{"", "Reprisal + Party Mit", "", "", "Spreadlo + Sacred Soil", "Kerachole + Holos + Zoe Shields", "Feint", "", "Party Mit", "Addle"}),
        ...
        new(450, "P3", "Bowels of Agony (Chaos)", 0xBAF2, new[]{"Reprisal", "", "Plenary Indulgence", "Collective Unconscious", "Sacred Soil", "Kerachole", "Feint (Chaos)", "", "", ""}),
        ...
        new(559, "P3", "Earthquake", 0, new[]{"Party Mit (GNB/DRK)", "", "", "Macrocosmos", "Sacred Soil", "Kerachole + Philosophia", "Feint (Chaos)", "", "", ""}),
        ...
        new(637, "P3", "Thunder III (5th Set)", 0, new[]{"Reprisal", "", "", "", "Spreadlo + Sacred Soil", "Zoe Shields + Kerachole", "", "Feint (Chaos)", "", "Addle (Exdeath)"}),
        ...
        new(763, "P4", "Grand Cross", 0xBB14, new[]{"", "", "Plenary Indulgence", "Collective Unconscious", "Spreadlo + Sacred Soil", "Kerachole + Philosophia + Holos", "", "Feint", "", ""}),
        ...
        new(840, "P4", "Death Bolt/Wave", 0xBB1B, new[]{"", "", "", "", "", "", "", "", "", ""}),
        ...
        new(971, "P5", "Celestriad", 0xBB42, new[]{"Party Mit", "", "", "", "Seraph", "", "", "", "", ""}),
        ...
        new(1062, "P5", "Forsaken (1st Hit)", 0xBB35, new[]{"Reprisal + Party Mit", "", "Temperance", "Neutral Sect", "Spreadlo + Fey Illumination + Sacred Soil", "Zoe Shields + Holos + Kerachole", "", "Feint", "", ""}),
