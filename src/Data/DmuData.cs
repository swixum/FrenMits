...
public static class DmuData
{
    ...
    public static readonly Entry[] Timeline =
    {
        ...
        new(43, "P1", "Wave Cannon", 0xBAA8, new[]{"Party Mit (WAR/PLD)", "", "Asylum", "", "Seraph", "Holos", "", "", "", "", ""}),
        ...
        new(133, "P1", "Light of Judgment", 0xC622, new[]{"Reprisal + Party Mit", "", "Asylum", "Collective Unconscious", "", "Kerachole", "Feint", "", "", "", ""}),
        ...
        new(451, "P3", "Bowels of Agony (Chaos)", 0xBAF2, new[]{"Reprisal", "", "Asylum", "Collective Unconscious", "Sacred Soil", "Kerachole", "Feint (Chaos)", "", "", "Addle (The Decisive Battle)", ""}),
        ...
        new(759, "P4", "Grand Cross + Inferno/Tsunami", 0xBB14, new[]{"", "", "Asylum", "Neutral Sect", "Spreadlo + Expedient + Sacred Soil", "Kerachole + Holos + Philosophia", "", "", "", "", ""}),
        ...
        new(833, "P4", "Death Bolt/Wave", 0xBB1B, new[]{"", "", "Asylum", "Collective Unconscious", "", "", "", "", "", "", ""}),
        ...
        new(1064, "P5", "Forsaken + Forsaken Bonds", 0xBB35, new[]{"Reprisal + Party Mit (GNB/DRK)", "", "Asylum", "Neutral Sect", "Spreadlo + Fey Illumination + Sacred Soil", "Zoe Shields + Holos + Philosophia + Kerachole", "", "Feint", "", "", "✔"}),
