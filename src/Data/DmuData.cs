...
public static class DmuData
{
    ...
    public static readonly Entry[] Timeline =
    {
        ...
        new(496, "P3", "Stray Flames/Tsumani + Cyclone", 0xC3F7, new[]{"","Party Mit","","","Seraphism + Expediant + Seraph","Holos","","","","",""}),
        ...
        new(595, "P3", "Thunder III (Exdeath)", 0xBB0C, new[]{"","Reprisal (After Thunder III Resolves)","","","","","","Feint (Chaos)","","",""}),
        ...
        new(905, "P5", "Ultima Repeater + Fell Forces (3x)", 0xC654, new[]{"Reprisal","Party Mit","Plenary Indulgence","Collective Unconscious","Spreadlo + Sacred Soil","Zoe Shields + Holos + Kerachole","","","Party Mit","","✔"}),
