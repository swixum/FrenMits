...
public static class DmuData
{
    ...
    public static readonly Entry[] Timeline =
    {
        ...
        new(281, "P2", "Towers IV (Past/Future's End)", 0xBABE, new[]{"", "", "", "", "", "", "", "", "", ""}, 1),
        ...
        new(511, "P3", "Ultima Blaster", 0xBB00, new[]{"Reprisal", "", "", "Sun Sign", "Sacred Soil + Fey Illumination + Seraphism", "Kerachole + Panhaima", "", "Feint (Chaos)", "Party Mit", ""}, 1),
        ...
        new(586, "P3", "Nothingness", 0, new[]{"","","","","","","","","",""}, 1),
        new(592, "P3", "Nothingness", 0, new[]{"","","","","","","","","",""}, 1),
        ...
        new(655, "P3", "Nothingness", 0, new[]{"","","","","","","","","",""}, 3),
        new(661, "P3", "Nothingness", 0, new[]{"","","","","","","","","",""}, 3),
        ...
        new(759, "P4", "Grand Cross", 0xBB14, new[]{"", "", "Plenary Indulgence + Asylum", "Collective Unconscious", "Spreadlo + Sacred Soil", "Kerachole + Philosophia + Holos", "", "Feint", "", ""}, 2),
        new(769, "P4", "Inferno/Tsunami", 0, new[]{"", "", "", "", "", "", "", "", "Party Mit", ""}, 2),
        new(774, "P4", "Grand Cross", 0xBB14, new[]{"", "", "Temperance", "Neutral Sect", "Expedient + Fey Illumination", "Panhaima", "", "", "", ""}, 2),
        new(783, "P4", "Inferno/Tsunami", 0, new[]{"", "Party Mit (GNB/DRK)", "", "Sun Sign", "Seraph", "", "", "", "", ""}, 2),
        new(789, "P4", "Grand Cross", 0xBB14, new[]{"", "Party Mit (WAR/PLD)", "Divine Caress", "", "Seraph", "Zoe Shields", "", "", "", ""}, 2),
        ...
        new(963, "P5", "Celestriad", 0xBB42, new[]{"Party Mit", "", "Asylum", "", "Seraph", "", "", "", "", ""}, 1, true),
        new(969, "P5", "Fire III", 0, new[]{"","","","","","","","","",""}, 1),
        new(969, "P5", "Thunder III", 0, new[]{"","","","","","","","","",""}, 1, true),
        new(978, "P5", "Blizzard III", 0, new[]{"","","","","","","","","",""}, 1),
        new(978, "P5", "Fire III", 0, new[]{"","","","","","","","","",""}, 1),
        new(978, "P5", "Thunder III", 0, new[]{"","","","","","","","","",""}, 1, true),
        new(984, "P5", "Blizzard III", 0, new[]{"","","","","","","","","",""}, 1),
