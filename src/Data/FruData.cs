...
public static class FruData
{
    ...
    public static readonly Entry[] Timeline =
    {
        ...
        new(333, "P2", "Light Rampant", 0x9D14, new[]{"Rep","","Concit/Soil","EukProg/Kera","","CU","","Feint","","Addle"}),
        new(350, "P2", "Powerful Light", 0x9D19, new[]{"","Party Mit","Spread-Lo/Seraphism","Zoe EukProg/Sophia","Bell","Macro","","","Party Mit",""}),
        new(390, "P2", "Absolute Zero", 0x9D8D, new[]{"Rep/Party Mit","","Concit/Soil","EukProg/Kera","Confession","CU","Feint","","",""}),
        ...
        new(588, "P3", "Shockwave Pulsar", 0x9D5A, new[]{"Rep","","Concit/Soil","EukProg/Kera","","","","Feint","",""}),
