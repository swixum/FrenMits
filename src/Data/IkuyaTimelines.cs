...
public static class IkuyaTimelines
{
    ...
    static List<SyncPoint> UcobSync() => new()
    {
        ...
        new() { Ability = 0x26AC, Time = 227f, IsPhase = false, Label = "P1 Fireball II" },
        ...
        new() { Ability = 0x26BD, Time = 667f, IsPhase = false, Label = "P2 Thermionic Beam (2nd Quote)" },
        ...
        new() { Ability = 0x26BA, Time = 1814f, IsPhase = false, Label = "P4 Megaflare I" },
        new() { Ability = 0x26BD, Time = 2008f, IsPhase = false, Label = "P4 Thermionic Beam (2nd Quote)" },
        new() { Ability = 0x26BA, Time = 2228f, IsPhase = false, Label = "P4 Megaflare II" },
    ...
    static List<SyncPoint> UwuSync() => new()
    {
        ...
        new() { Ability = 0x2B62, Time = 716f, IsPhase = false, Label = "P3 Rock Slide + Mountain Buster" },
        new() { Ability = 0x2B8B, Time = 850f, IsPhase = true , Label = "P4 Ultima" },
        new() { Ability = 0x2B87, Time = 1004f, IsPhase = false, Label = "P4 Tank Purge" },
        new() { Ability = 0x2B7A, Time = 1017f, IsPhase = false, Label = "P4 Viscous Aetheroplasm" },
        new() { Ability = 0x2B49, Time = 1119f, IsPhase = false, Label = "P4 Mesohigh" },
        ...
        new() { Ability = 0x2CD4, Time = 1520f, IsPhase = false, Label = "P4 Primal I" },
    };
    ...
    static List<SyncPoint> DsrSync() => new()
    {
        ...
        new() { Ability = 0x6709, Time = 1002f, IsPhase = false, Label = "P2 Final Chorus" },
        ...
        new() { Ability = 0x63C6, Time = 3208f, IsPhase = false, Label = "P5 Ancient Quaga" },
        ...
        new() { Ability = 0x6D99, Time = 4163f, IsPhase = false, Label = "P7 Gigaflare I" },
    };
    ...
    static List<SyncPoint> TopSync() => new()
    {
        ...
        new() { Ability = 0x7B53, Time = 428f, IsPhase = false, Label = "P2 Sniper Cannon Fodder (Transition)" },
