...
public static class IkuyaTimelines
{
    ...
    static readonly Entry[] Ucob =
    {
        ...
        new(97, "P1", "Fireball II", new[]{"","","Plenary Indulgence","Collective Unconscious","Fey Illumination + Sacred Soil","Kerachole","Feint","","","Addle"}),
        ...
        new(682, "P4", "Megaflare I", new[]{"Reprisal + Party Mit","Party Mit","Plenary Indulgence","Collective Unconscious","Carry Over + Spreadlo","Zoe Shields + Kerachole (If Available)","","","Party Mit","Addle"}),
    ...
    static readonly Entry[] Uwu =
    {
        ...
        new(51, "P1", "Friction I", new[]{"Party Mit (GNB/DRK)","","Plenary Indulgence","Collective Unconscious","Fey Illumination","Kerachole","Feint","","Party Mit",""}),
    ...
    static readonly Entry[] Tea =
    {
        ...
        new(42, "P1", "Hand of Pain", new[]{"120s","120s + Party Mit","Plenary Indulgence","Neutral Sect","Spreadlo + Sacred Soil","Holos + Kerachole","","","Party Mit + Personals","Personals"}),
        ...
        new(285, "P2", "Photon", new[]{"","","Benediction (MT)","Essential Dignity (MT)","Excogitation (OT)","Taurochole (OT)","","","",""}),
    ...
    static readonly Entry[] Dsr =
    {
        ...
        new(70, "P2", "Ancient Quaga", new[]{"","Reprisal","Plenary Indulgence","Collective Unconscious","Carry Over + Sacred Soil","Carry Over + Kerachole","Feint","","","Addle"}),
        ...
        new(165, "P2", "Ultimate End", new[]{"Party Mit","Reprisal","Plenary Indulgence","Collective Unconscious","Sacred Soil","Kerachole","Feint","","","Addle"}),
        ...
        new(318, "P3", "Resentment", new[]{"Party Mit (WAR/PLD after bleed expires)","","","Collective Unconscious","Spreadlo + Sacred Soil","Zoe Shields + Kerachole","","","",""}),
