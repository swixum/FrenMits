...
public static class IkuyaTimelines
{
    ...
    static readonly Entry[] Ucob =
    {
        ...
        new(693, "P4", "Thermionic Beam (1st Quote)", new[]{"Reprisal (If Applicable)","","","","Fey Illumination + Sacred Soil","Kerachole","Feint","","",""}, 3),
    ...
    static readonly Entry[] Uwu =
    {
        ...
        new(262, "P3", "Tumult (x8)", new[]{"Party Mit","Reprisal + Party Mit","","","Sacred Soil","Kerachole","Feint","","","Addle"}, 3),
    ...
    static readonly Entry[] Tea =
    {
        ...
        new(285, "P2", "Photon", new[]{"","","Benediction (MT)","Essential Dignity (MT)","Excogitation (OT)","Taurochole (OT)","","","",""}, 1),
        ...
        new(402, "P3", "Plaint of Severity", new[]{"","","","","","","","","",""}, 1),
        new(402, "P3", "Plaint of Solidarity", new[]{"","","","","","","","","",""}, 1),
    ...
    static readonly Entry[] Top =
    {
        ...
        new(88, "P1", "Guided Missile Kyrios", new[]{"","","","","","","","","",""}, 1),
        new(94, "P1", "Condensed Wave Cannon Kyrios", new[]{"","","","","","","","","",""}, 2),
        new(94, "P1", "Guided Missile Kyrios", new[]{"","","","","","","","","",""}, 1),
        new(100, "P1", "Condensed Wave Cannon Kyrios", new[]{"","","","","","","","","",""}, 2),
        new(100, "P1", "Guided Missile Kyrios", new[]{"","","","","","","","","",""}, 1),
        ...
        new(748, "P5", "Oversampled Wave Cannon", new[]{"","","","","","","","","",""}, 1),
