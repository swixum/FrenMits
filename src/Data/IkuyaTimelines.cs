...
public static class IkuyaTimelines
{
    ...
    static readonly Entry[] Ucob =
    {
        ...
        new(184, "P2", "Thermionic Beam (1st Quote)", new[]{"Reprisal (If Applicable)","","","","Sacred Soil","Kerachole","","Feint","","","Dismantle (If Applicable)"}),
        new(209, "P2", "Thermionic Beam (2nd Quote)", new[]{"Party Mit","Reprisal + Party Mit","Plenary Indulgence","Collective Unconsciousness","Spreadlo + Soil","Kerachole","Feint","","","Addle","Dismantle"}),
        ...
        new(456, "P3", "Heavensfall Trio", new[]{"Reprisal","Party Mit (Fireball + Gigaflare)","Plenary Indulgence (Fireball + Gigaflare)","Collective Unconsciousness (Fireball + Gigaflare)","Spreadlo + Fey Illumination + Sacred Soil","Zoe Shields + Kerachole","","","Party Mit (If Used During Transition)","Addle","Dismantle"}),
        ...
        new(682, "P4", "Megaflare I", new[]{"Reprisal + Party Mit","Party Mit","Plenary Indulgence","Collective Unconsciousness","Carry Over + Spreadlo","Zoe Shields + Kerachole (If Available)","","","Party Mit","Addle","Dismantle"}),
        ...
        new(872, "P5", "Morn Afah II", new[]{"Reprisal","Party Mit","","","Spreadlo + Sacred Soil","Zoe Shields + Kerachole","","Feint","","","Dismantle"}),
        ...
        new(1040, "P5", "Morn Afah V", new[]{"Party Mit","Reprisal","Plenary Indulgence","Collective Unconsciousness","Spreadlo + Sacred Soil","Zoe Shields + Kerachole","Feint","","","Addle","Dismantle"}),
    };
    ...
    static readonly Entry[] Uwu =
    {
        ...
        new(150, "P2", "Hellfire", new[]{"","Reprisal","","","","","Feint","","","Addle","Dismantle"}),
        ...
        new(263, "P3", "Tumult (x6)", new[]{"Reprisal","","Plenary Indulgence","Collective Unconsious","Sacred Soil + Fey Ilumination","Kerachole","","","Party Mit","","Dismantle"}),
        ...
        new(608, "P4", "Tank Purge", new[]{"Reprisal","Party Mit","Plenary Indulgence","Collective Unconsious","Sacred Soil","Kerachole","Feint","","","","Dismantle"}),
    ...
    static readonly Entry[] Tea =
    {
        ...
        new(86, "P1", "Splash (x6) + Drainage", new[]{"Kitchen Sink + Reprisal + Party Mit (DRK/GNB)","Invulnerability (DRK Only) or Kitchen Sink","Asylum + Temperance","","Seraph + Fey Illumination + Soil","Panhaima + Kerachole","","Feint (Living Liquid)","","Addle (Living Liquid)","Dismantle (Living Liquid)"}),
        ...
        new(195, "P2", "Water/Thunder I", new[]{"Rampart + Short Mit","Rampart (After Water Resolves)","","","Carry Over","Carry Over","","Feint (Brute Justice)","","","Dismantle (Brute Justice)"}),
        ...
        new(317, "P2", "Whirlwind", new[]{"","Reprisal","","","","","Feint (Cruise Chaser)","","","Addle (Cruise Chaser)","Dismantle (Cruise Chaser)"}),
        ...
        new(423, "P3", "Chastening Heat + Divine Spear", new[]{"Provoke (After 3rd Divine Spear)","Kitchen Sink (Chastening Heat) + Invulnerability","","","","","","","","","Dismantle"}),
        ...
        new(647, "P3", "J Waves (20-30s)", new[]{"","Party Mit","Cure III","Aspected Helios","Succor","Eukrasian Prognosis","","","","","Dismantle"}),
        ...
        new(774, "P4", "Ordained Capital Punishment", new[]{"Kitchen Sink","Kitchen Sink + Reprisal","","","","","","Feint","","","Dismantle"}),
        ...
        new(954, "P4", "Irresistible Grace", new[]{"Party Mit","Reprisal + Party Mit","Plenary Indulgence","Neutral Sect + Collective Unconscious","Seraph + Fey Illumination + Soil","Panhaima + Kerachole","","Feint","Party Mit","","Dismantle"}),
    };
    ...
    static readonly Entry[] Dsr =
    {
        ...
        new(30, "P2", "Strength of the Ward", new[]{"Party Mit","Party Mit","Temperance + Liturgy of the Bell","Neutral Sect","Fey Illumination + Expedient","Holos","","","Party Mit","","RDM"}),
        new(70, "P2", "Ancient Quaga", new[]{"","Reprisal","Plenary Indulgence","Collective Unconsious","Carry Over + Sacred Soil","Carry Over + Kerachole","Feint","","","Addle","MCH"}),
        ...
        new(186, "P2", "Final Chorus", new[]{"","Party Mit","","Neutral Sect","Spreadlo + Sacred Soil","Zoe Shields + Holos + Kerachole","","","Party Mit","","RDM"}),
        new(252, "P3", "First Stack", new[]{"Reprisal","","Temperance","Carry Over (Neutral Sect)","Fey Illumination + Sacred Soil","Kerachole","","Feint","","",""}),
        new(285, "P3", "Second Stack", new[]{"Party Mit (If Available)","Reprisal","Plenary Indulgence","Collective Unconscious","Seraph + Expedient + Sacred Soil (If Available","Panhaima + Kerachole (If Available)","Feint (If Available)","","","Addle (If Available)","MCH"}),
        ...
        new(433, "Int", "Tanks", new[]{"","Reprisal","Plenary Indulgence","Collective Unconscious","","","","Feint","","Addle","MCH/RDM"}),
        ...
        new(704, "P6", "Wroth Flames", new[]{"Reprisal + Party Mit","Party Mit","Everything","Neutral Sect","Everything","Everything","Feint (Nidhogg)","Feint (Either Hallowed Plume)","Party Mit","Addle (Nidhogg)","MCH/RDM"}),
        ...
        new(852, "P7", "Alternative End", new[]{"Party Mit","Party Mit","Plenary Indulgence","Collective Unconscious","Spreadlo","Zoe Shields + Holos","","","Party Mit","","RDM"}),
        new(885, "P7", "Ahk Morn I", new[]{"Reprisal","","Temperance","Neutral Sect","Fey Illumination","Panhaima","Feint","","","Addle",""}),
        new(919, "P7", "Gigaflare I", new[]{"","Reprisal","Plenary Indulgence","Collective Unconscious","Expedient + Seraph","","","Feint","","","MCH"}),
        new(959, "P7", "Ahk Morn II", new[]{"Reprisal + Party Mit","Party Mit","Liturgy of the Bell","","","Zoe Shields","","","Party Mit","","RDM"}),
        new(999, "P7", "Gigaflare II", new[]{"","Reprisal","Plenary Indulgence","Collective Unconscious + Macrocosmos","Spreadlo","","Feint","","","Addle",""}),
        new(1039, "P7", "Akh Morn III", new[]{"Reprisal + Party Mit","Party Mit","Everything","","","","","Feint","Party Mit","","MCH"}),
    };
    ...
    static readonly Entry[] Top =
    {
        ...
        new(104, "P1", "Stack I", new[]{"Reprisal","","","","","","Feint","","Party Mit","","Magick Barrier"}),
        new(121, "P1", "Stack II", new[]{"","","","","Seraph","","","","","",""}),
        new(129, "P1", "Stack III", new[]{"","Reprisal","","","Seraph","","","Feint","","Addle","Dismantle"}),
        new(138, "P2", "Solar Ray", new[]{"","","Assist Tanks","Assist Tanks","Sacred Soil","Kerachole","","","","",""}),
        new(214, "P2", "Optomized Meteor (6-1-1)", new[]{"Party Mit","","Everything","","","","","","Party Mit","","RDM"}),
        ...
        new(371, "P3", "3rd Patch Set", new[]{"","","Liturgy of the Bell","Macrocosmos","Fey Illumination + Seraph + Sacred Soil","Kerachole","","Feint","Party Mit","","MCH"}),
        new(389, "P3", "4th Patch Set", new[]{"Reprisal","Party Mit","","","","Holos","","","","","RDM"}),
        ...
        new(541, "P5", "Delta", new[]{"Reprisal","","Plenary Indulgence","Collective Unconscious","Spreadlo + Sacred Soil","Zoe Shields + Holos + Kerachole","","Feint","Party Mit","Addle","MCH/RDM/PCT"}),
        ...
        new(712, "P5", "Omega", new[]{"Reprisal + Party Mit","Party Mit","Plenary Indulgence","Collective Unconscious","Spreadlo + Fey Illumination + Sacred Soil","Zoe Shields + Holos + Kerachole","","Feint","Party Mit","Addle","MCH/RDM/PCT"}),
