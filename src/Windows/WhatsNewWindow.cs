...
public class WhatsNewWindow : Window
{
    ...
    {
        ("1.0.0.171", "Every Sheet View popup (New sheet, History, Add row, Replace, imports) now has a title and a close X."),
        ("1.0.0.170", "The tank-pairing pick in Tank busters is now remembered per fight."),
